 ...
 */
//病人列表
public class MCHospitalPatientListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivityManager.pushOneActivity(MCHospitalPatientListActivity.this);
        myApp = (MyApp)getApplication();


        patientListView = (ListView)findViewById(R.id.patient_listview);
        patientListAdapter = new MCPatientListAdapter(MCHospitalPatientListActivity.this,myApp,data,"hospitalTab");
...
//                    Toast.makeText(Main.this,"输入的是数字", Toast.LENGTH_SHORT).show();
                ...
                patientListAdapter.notifyDataSetChanged();
                if(data.isEmpty()){
                    Toast.makeText(MCHospitalPatientListActivity.this, "无搜索结果", Toast.LENGTH_LONG).show();
                }
            }
