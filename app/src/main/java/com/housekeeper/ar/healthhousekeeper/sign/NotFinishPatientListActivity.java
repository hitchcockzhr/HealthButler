 ...
 */
//未完成签约患者列表
public class NotFinishPatientListActivity extends Activity {


    String TAG = "NotFinishPatientListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivityManager.pushOneActivity(NotFinishPatientListActivity.this);

        titleLayout = (LinearLayout)findViewById(R.id.title_layout);
        titleLayout.setVisibility(View.GONE);

        patientListView = (ListView)findViewById(R.id.patient_listview);
        patientListAdapter = new SignPatientListAdapter(NotFinishPatientListActivity.this,data,2);
...
//                    Toast.makeText(Main.this,"输入的是数字", Toast.LENGTH_SHORT).show();
                ...
                patientListAdapter.notifyDataSetChanged();
                if(data.isEmpty()){
                    Toast.makeText(NotFinishPatientListActivity.this, "无搜索结果", Toast.LENGTH_LONG).show();
                }
            }
