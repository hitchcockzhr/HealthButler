 ...
 */
public class FUTableAuxBloodSugarView extends ViewGroup {
    private String TAG = "FUTableAuxBloodSugarView";
    ...
    public FUTableAuxBloodSugarView(Context context) {
        super(context);

    }

    public FUTableAuxBloodSugarView(Context context, LinearLayout parent,String from){
        this(context);
...
//        this.addView(biochemicalView);
        ...
        ghET.addTextChangedListener(ghTextWatcher);
        pbgET.addTextChangedListener(pbgTextWatcher);
        fbgET.addTextChangedListener(fbgTextWatcher);
        fbgLevelTV.setOnClickListener(clickListener);
        pbgLevelTV.setOnClickListener(clickListener);
        ghLevelTV.setOnClickListener(clickListener);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.hospital_aux:
                    ...
                    break;
                case R.id.fbg_level_tv:
                    if(!fbgLevelTV.getText().toString().equals("正常")&& !fbgLevelTV.getText().toString().equals("")){

                        Intent intent = new Intent(mContext,FUTableAuxFbgUnderstandingActivity.class);
                        mContext.startActivity(intent);

                    }
                    break;
                case R.id.glycosylated_hemoglobin_level_tv:
                    //糖化血糖蛋白
                    if(!ghLevelTV.getText().toString().equals("正常")&&!ghLevelTV.getText().toString().equals("")){

                        Intent intent = new Intent(mContext,FUTableAuxGhUnderstandingActivity.class);
                        mContext.startActivity(intent);

                    }
                    break;
                case R.id.pbg_level_tv:
                    if(!pbgLevelTV.getText().toString().equals("正常")&& !pbgLevelTV.getText().toString().equals("")){

                        Intent intent = new Intent(mContext,FUTableAuxPbgUnderstandingActivity.class);
                        mContext.startActivity(intent);
    ...
    private TextWatcher ghTextWatcher = new TextWatcher() {
        @Override
    ...
    private TextWatcher fbgTextWatcher = new TextWatcher() {
        @Override
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
    ...
    private TextWatcher pbgTextWatcher = new TextWatcher() {
        @Override
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
