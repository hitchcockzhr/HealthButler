...
public class UpdateVersionActivity extends BaseActivity {
	...
	private TextView nowVersionIDTextView;
	private TextView nowVersionRightArrowView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyActivityManager.pushOneActivity(UpdateVersionActivity.this);
		myApp = (MyApp)getApplication();
//		jsonList = myApp.getJsonList();
		http = myApp.getHttp();
		medicalRecordId = myApp.getMedicalRecordId();
		updateBtn = (Button)findViewById(R.id.update_btn);
		nowVersionIDTextView = (TextView)findViewById(R.id.now_version_id_tv);
		nowVersionRightArrowView = (TextView)findViewById(R.id.now_version_right_arrow);
		nowVersionRightArrowView.setClickable(true);
		...
		nowVersionRightArrowView.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(UpdateVersionActivity.this,UpdateVersionLogActivity.class);
		...
		updateBtn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(UpdateVersionActivity.this,UpdateVersionFinishActivity.class);
				startActivity(intent);
			}
		});
		nowVersionIDTextView.setText("6.2.1");
		newVersionIDTextView.setText("6.2.2");
