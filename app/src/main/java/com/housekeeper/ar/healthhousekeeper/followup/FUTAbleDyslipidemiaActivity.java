 ...
 */
public class FUTAbleDyslipidemiaActivity extends BaseActivity {
    String TAG="FUTAbleDyslipidemiaActivity";
    ...
    private MyTextView waistlineTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_follow_up_table_dyslipidemia_new);

        SysApplication.getInstance().addActivity(this);
        toastCommom = ToastCommom.createToastConfig();
        MyActivityManager.pushOneActivity(FUTAbleDyslipidemiaActivity.this);
        ...
        waistlineTV = (MyTextView)findViewById(R.id.waistline_tv);
...
//                map.put("selected","false");
    ...
    private void initXChartData(){
        ...
        //设置六边形数据
        waistlineTV.setRadarViewData(radarViewData);
        waistlineTV.setRadarViewMaxValue(100);
        waistlineTV.setRadarViewTitles(radarViewTitles);
        //设置折线数据
        waistlineTV.setLineData(waistlineTV.getText().toString(), yMax, ySteps, yDetailSteps, xLabels, dataTextList, dataColorList, dataList);
    ...
    private void initSpinner(){
        ...
        ArrayAdapter<String> psyRecoveryAdapter = new ArrayAdapter<String>
                (FUTAbleDyslipidemiaActivity.this, R.layout.spinner_item,getPsyRecoveryData()){
            @Override
        ...
        ArrayAdapter<String> fdibAdapter = new ArrayAdapter<String>
                (FUTAbleDyslipidemiaActivity.this, R.layout.spinner_item,getFDIBData()){
            @Override
            public View getDropDownView(int position, View convertView, ViewGroup parent) {
                LayoutInflater inflater=(LayoutInflater)getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View view = inflater.inflate(R.layout.spinner_item_layout,
            ...
            switch (v.getId()){
                ...
                case R.id.blood_pressure_level_tv:
                    if(!bloodPressLevelTV.getText().toString().equals("正常")){
                        Intent intent = new Intent(FUTAbleDyslipidemiaActivity.this,FUTableAuxBloodPressUnderstandingActivity.class);
                        startActivity(intent);
                    }
                    break;
                case R.id.bmi_level_tv:
                    if(!bmiLevelTV.getText().toString().equals("正常")&& !bmiLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(FUTAbleDyslipidemiaActivity.this,FUTableAuxHeightWeightUnderstandingActivity.class);
                        startActivity(intent);
                    }
                    break;
            }
    ...
    private void addAuxCheck(){
        ...
        addAuxDialog = new MyDialog(FUTAbleDyslipidemiaActivity.this, functionListView,R.style.load_dialog);
        ...
        if(currentAuxList != null && !currentAuxList.isEmpty()){
            ...
            for(HashMap<String,String> map:currentAuxList){
                ...
                if(map.get("name").equals("血脂全项")){
                    ...
                    bloodFatView = new FUTableAuxBloodFatView(FUTAbleDyslipidemiaActivity.this,auxAddLayout,"血脂异常");
                }else if(map.get("name").equals("血流变参数")){

                    hemorheologyParamView = new FUTableAuxHemorheologyParamView(FUTAbleDyslipidemiaActivity.this,auxAddLayout,"血脂异常");
                }else if(map.get("name").equals("血糖")){

                    bloodSugarView = new FUTableAuxBloodSugarView(FUTAbleDyslipidemiaActivity.this,auxAddLayout,"血脂异常");
                }else if(map.get("name").equals("尿常规")){

                    urineRoutineView = new FUTableAuxUrineRoutineView(FUTAbleDyslipidemiaActivity.this,auxAddLayout,"血脂异常");
                }else if(map.get("name").equals("肝功能")){

                    liverFunctionView = new FUTableAuxLiverFunctionView(FUTAbleDyslipidemiaActivity.this,auxAddLayout,"血脂异常");
                }
            }
        }
