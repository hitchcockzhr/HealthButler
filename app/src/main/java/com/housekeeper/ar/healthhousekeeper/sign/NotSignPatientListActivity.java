 ...
 */
//未签约患者列表
public class NotSignPatientListActivity extends Activity {


    String TAG = "NotSignPatientListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivityManager.pushOneActivity(NotSignPatientListActivity.this);

        titleLayout = (LinearLayout)findViewById(R.id.title_layout);
        titleLayout.setVisibility(View.GONE);

        patientListView = (ListView)findViewById(R.id.patient_listview);
        patientListAdapter = new SignPatientListAdapter(NotSignPatientListActivity.this,data,0);
...
//                    Toast.makeText(Main.this,"输入的是数字", Toast.LENGTH_SHORT).show();
                ...
                patientListAdapter.notifyDataSetChanged();
                if(data.isEmpty()){
                    Toast.makeText(NotSignPatientListActivity.this, "无搜索结果", Toast.LENGTH_LONG).show();
                }
            }
