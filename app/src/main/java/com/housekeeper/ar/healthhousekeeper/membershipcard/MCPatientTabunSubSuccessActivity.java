 ...
 */
//退卡成功
public class MCPatientTabunSubSuccessActivity extends BaseActivity {


    String TAG = "MCPatientTabunSubSuccessActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_membership_patient_tab_unsub_success);

        SysApplication.getInstance().addActivity(this);
        toastCommom = ToastCommom.createToastConfig();
        MyActivityManager.pushOneActivity(MCPatientTabunSubSuccessActivity.this);
