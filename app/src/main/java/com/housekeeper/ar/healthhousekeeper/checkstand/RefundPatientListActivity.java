 ...
 */
//退款
public class RefundPatientListActivity extends Activity {


    String TAG = "RefundPatientListActivity";
    String getRefundListUrl = "shlc/healthButler/refundMedicalRecord?patientNameOrPhone=";
    MyApp myApp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivityManager.pushOneActivity(RefundPatientListActivity.this);
        ...
        patientListAdapter = new PayPatientListAdapter(RefundPatientListActivity.this,data,1);
    ...
    private void initData(){
        data.clear();
        httpUrl = http + getRefundListUrl + searchEditText.getText().toString();
        Log.i(TAG, "refund url: "+httpUrl);
        HttpPost post = HttpUtil.getPost(httpUrl, null);
        JSONObject joRev = HttpUtil.getString(post, 3);
        Log.i(TAG, "jo refund: "+joRev.toString());
        try {
