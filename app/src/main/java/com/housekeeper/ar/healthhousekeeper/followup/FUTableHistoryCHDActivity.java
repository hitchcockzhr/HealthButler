 ...
 */
public class FUTableHistoryCHDActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_follow_up_table_history_chd);

        SysApplication.getInstance().addActivity(this);
        toastCommom = ToastCommom.createToastConfig();
        MyActivityManager.pushOneActivity(FUTableHistoryCHDActivity.this);
...
//        currentAuxList.clear();
    ...
    private void initSelectSymptomData(JSONObject josymptomslist) throws JSONException {
        ...
        if(josymptomslist.getInt("noLieFlat") == 1){
            selectedSymptomLists.add("不能平卧");
        }
        ...
        if(josymptomslist.getInt("asthmatic") == 1){
            selectedSymptomLists.add("喘憋");
        }
        if(josymptomslist.getInt("anginaPectoris") == 1){
            selectedSymptomLists.add("心绞痛");
        }
        ...
        if(josymptomslist.getInt("stuffyPain") == 1){
            selectedSymptomLists.add("胸口闷痛");
        }
        if(josymptomslist.getInt("palpitation") == 1){
            selectedSymptomLists.add("心慌");
        }
...
//                map.put("selected","false");
    ...
    private void initSpinner(){
        ...
        ArrayAdapter<String> psyRecoveryAdapter = new ArrayAdapter<String>
                (FUTableHistoryCHDActivity.this, R.layout.spinner_item,getPsyRecoveryData()){
            @Override
        ...
        ArrayAdapter<String> fdibAdapter = new ArrayAdapter<String>
                (FUTableHistoryCHDActivity.this, R.layout.spinner_item,getFDIBData()){
            @Override
            public View getDropDownView(int position, View convertView, ViewGroup parent) {
                LayoutInflater inflater=(LayoutInflater)getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View view = inflater.inflate(R.layout.spinner_item_layout,
            ...
            switch (v.getId()){
                ...
                case R.id.blood_pressure_level_tv:
                    if(!bloodPressLevelTV.getText().toString().equals("正常")){
                        Intent intent = new Intent(FUTableHistoryCHDActivity.this,FUTableAuxBloodPressUnderstandingActivity.class);
                ...
                case R.id.bmi_level_tv:
                    if(!bmiLevelTV.getText().toString().equals("正常")&& !bmiLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(FUTableHistoryCHDActivity.this,FUTableAuxHeightWeightUnderstandingActivity.class);
                        startActivity(intent);
                    }
                    break;
            }
    ...
    private void addAuxCheck(){
        ...
        addAuxDialog = new MyDialog(FUTableHistoryCHDActivity.this, functionListView,R.style.load_dialog);
        ...
        if(currentAuxList != null && !currentAuxList.isEmpty()){
            ...
            for(HashMap<String,String> map:currentAuxList){
                ...
                if(map.get("name").equals("血脂全项")){
                    ...
                    bloodFatView = new FUTableAuxBloodFatView(FUTableHistoryCHDActivity.this,auxAddLayout,"冠心病");
                }else if(map.get("name").equals("心肌酶学检查结果")){
                    myocardialEnzymeView = new FUTableAuxMyocardialEnzymeView(FUTableHistoryCHDActivity.this,auxAddLayout,"冠心病");
                }else if(map.get("name").equals("心电图检查结果")){
                    ecgEditView = new FUTableAuxEditView(FUTableHistoryCHDActivity.this,auxAddLayout,"心电图检查结果","冠心病");
                }else if(map.get("name").equals("心电图运动负荷实验结果")){
                    ecgLoadEditView = new FUTableAuxEditView(FUTableHistoryCHDActivity.this,auxAddLayout,"心电图运动负荷实验结果","冠心病");
                }else if(map.get("name").equals("心脏彩超检查结果")){
                    meEditView = new FUTableAuxEditView(FUTableHistoryCHDActivity.this,auxAddLayout,"心脏彩超检查结果","冠心病");
                }else if(map.get("name").equals("冠状动脉造影结果")){
                    caEditView = new FUTableAuxEditView(FUTableHistoryCHDActivity.this,auxAddLayout,"冠状动脉造影结果","冠心病");
                }
            }
        }
