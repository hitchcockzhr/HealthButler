 ...
 */
public class FUTableAuxMyocardialEnzymeView extends ViewGroup {
    private String TAG = "FUTableAuxMyocardialEnzymeView";
    private LinearLayout parentView;
    View view;
    Context mContext;
    String name = "心肌酶学检查结果";
    private String from;
    public FUTableAuxMyocardialEnzymeView(Context context) {
        super(context);
        mContext = context;
    }

    public FUTableAuxMyocardialEnzymeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    public FUTableAuxMyocardialEnzymeView(Context context, LinearLayout parent,String from){
        this(context);
    ...
    private void initView(){
        ...
        meET.addTextChangedListener(meWatcher);
...
//        meLevelTV.setText("↑");
    ...
    private TextWatcher meWatcher = new TextWatcher() {
