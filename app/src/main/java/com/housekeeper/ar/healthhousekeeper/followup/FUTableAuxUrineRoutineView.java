 ...
 */
public class FUTableAuxUrineRoutineView extends ViewGroup {
    private String TAG = "FUTableAuxUrineRoutineView";
    ...
    public FUTableAuxUrineRoutineView(Context context) {
        super(context);

    }

    public FUTableAuxUrineRoutineView(Context context, LinearLayout parent,String from){
        this(context);
    ...
    private TextView bloLevelTV,colLevelTV,rbcLevelTV,ketLevelTV,bilLevelTV,gluLevelTV,proLevelTV,wbcLevelTV;
...
//        this.addView(biochemicalView);
        ...
        bloLevelTV=(TextView)view.findViewById(R.id.blo_level_tv);
        colLevelTV=(TextView)view.findViewById(R.id.col_level_tv);
        rbcLevelTV=(TextView)view.findViewById(R.id.rbc_level_tv);
        ketLevelTV=(TextView)view.findViewById(R.id.ket_level_tv);
        bilLevelTV=(TextView)view.findViewById(R.id.bil_level_tv);
        gluLevelTV=(TextView)view.findViewById(R.id.glu_level_tv);
        proLevelTV=(TextView)view.findViewById(R.id.pro_level_tv);
        wbcLevelTV=(TextView)view.findViewById(R.id.wbc_level_tv);

        bloLevelTV.setOnClickListener(clickListener);
        colLevelTV.setOnClickListener(clickListener);
        rbcLevelTV.setOnClickListener(clickListener);
        ketLevelTV.setOnClickListener(clickListener);
        bilLevelTV.setOnClickListener(clickListener);
        gluLevelTV.setOnClickListener(clickListener);
        proLevelTV.setOnClickListener(clickListener);
        wbcLevelTV.setOnClickListener(clickListener);
        ...
        phLevelTextView.setOnClickListener(clickListener);
        sgLevelTextView.setOnClickListener(clickListener);
        uroLevelTextView.setOnClickListener(clickListener);
    ...
    private OnClickListener clickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.ph_value_level_tv:
                    if(!phLevelTextView.getText().toString().equals("正常")&&!phLevelTextView.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","酸碱度");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.urine_specific_gravity_level_tv:
                    if(!sgLevelTextView.getText().toString().equals("正常")&&!sgLevelTextView.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","尿比重");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.uro_level_tv:
                    if(!uroLevelTextView.getText().toString().equals("正常")&&!uroLevelTextView.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","尿胆原");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.blo_level_tv:
                    if(!bloLevelTV.getText().toString().equals("正常")&&!bloLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","隐血");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.wbc_level_tv:
                    if(!wbcLevelTV.getText().toString().equals("正常")&&!wbcLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                ...
                case R.id.glu_level_tv:
                    if(!gluLevelTV.getText().toString().equals("正常")&&!gluLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","尿糖");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.bil_level_tv:
                    if(!bilLevelTV.getText().toString().equals("正常")&&!bilLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","胆红素");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.ket_level_tv:
                    if(!ketLevelTV.getText().toString().equals("正常")&&!ketLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","酮体");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.rbc_level_tv:
                    if(!rbcLevelTV.getText().toString().equals("正常")&&!rbcLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","尿红细胞");
                        mContext.startActivity(intent);
                    }
                    break;
                case R.id.col_level_tv:
                    if(!colLevelTV.getText().toString().equals("正常")&&!colLevelTV.getText().toString().equals("")){
                        Intent intent = new Intent(mContext,FUTableAuxUrineRoutineUnderstandingActivity.class);
                        intent.putExtra("name","尿液颜色");
                        mContext.startActivity(intent);
                    }
                    break;
            }
    ...
    private void initUrineSpinner(){
        ...
        bloSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(bloString.equals("-")){
                    bloLevelTV.setText("正常");
                }else{
                    bloLevelTV.setText("不正常");
                }
            }
        ...
        wbcSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(wbcString.equals("-")){
                    wbcLevelTV.setText("正常");
                }else{
                    wbcLevelTV.setText("不正常");
                }
            }
        ...
        bilSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(bilString.equals("-")){
                    bilLevelTV.setText("正常");
                }else{
                    bilLevelTV.setText("不正常");
                }
            }
        ...
        ketSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(ketString.equals("-")){
                    ketLevelTV.setText("正常");
                }else{
                    ketLevelTV.setText("不正常");
                }
            }
        ...
        colSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(colString.equals("浅黄色至深黄色")){
                    colLevelTV.setText("正常");
                }else{
                    colLevelTV.setText("不正常");
                }
            }
    ...
    private void initUrineData(){
        phValueET.setText("10");
        sgValueET.setText("3.5");
        uroValueET.setText("15");
